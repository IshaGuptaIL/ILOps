...
namespace LegacyApp.Controllers.User
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ApiResposne> SaveRolePermissions([FromBody] RolePermissionSaveModel model)
        {
            return await _user.SaveRolePermissions(model.RoleId, model.MenuIds);
        }
